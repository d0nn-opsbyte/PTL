...
function Home() {
  return (
    <><section className="home" style={{ textAlign: 'center', padding: '20px' }}>
          ...
          <section className="products">
            ...
            <div className="product-grid">
              ...
              <div className="product-card">
                ...
                <p>Extra high intensity solar panels</p>
              </div>
            </div>
          </section>
        </div>
      ...
      <section style={{ textAlign: "center", padding: "10px", background: "#f4f4f4" }}>
        <h2>About us</h2>
        <p>
          At Petom Trading Limited, we power possibilities.
We specialize in providing high-quality electrical products that are reliable, safe, and built to last — from everyday home essentials to advanced solutions for businesses.

Our mission is simple: to make access to dependable electrical products easy, affordable, and hassle-free. We combine expert knowledge with a genuine passion for helping our customers find the right solutions for their needs. Whether you’re a homeowner upgrading your space or a professional tackling a big project, we’re here to guide you every step of the way.

With us, you’re not just buying a product — you’re partnering with a team that values trust, quality, and long-lasting relationships.
